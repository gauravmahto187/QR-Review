...
import { generateQrSvg, qrSvgDataUrl } from "@/server/services/qr-code";
...
export default async function BusinessQrPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    previewUrl = qrSvgDataUrl(await generateQrSvg(publicUrl));
  } catch {
