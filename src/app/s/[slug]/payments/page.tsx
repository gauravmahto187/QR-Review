...
export default async function PaymentsPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="min-h-dvh bg-slate-50 px-5 py-5 sm:px-6 sm:py-10"><div className="mx-auto w-full max-w-[460px]">
    ...
    <footer className="mt-10 pb-4 text-center text-[0.7rem] text-slate-400"><BrandLogo className="mx-auto h-5 w-20 opacity-60" /><span className="mt-2 block">Powered by NexGen Digital</span><DeveloperCredit /></footer>
  </div></main>;
}
