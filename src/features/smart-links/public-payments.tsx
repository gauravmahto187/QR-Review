...
export function PublicPayments({ slug, methods }: { slug: string; methods: { id: string; name: string }[] }) {
  ...
  async function open(id: string) {
    ...
    finally { opening.current = false; setPendingId(undefined); setPending(false); }
  }
